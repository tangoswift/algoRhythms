...
function initializeGoogleYoloMock() {
  return {
    cancelLastOperation: mockControl.createFunctionMock('cancelLastOperation'),
...
function testGoogleYolo_cancel() {
  ...
  googleYolo.cancel()
  googleYolo.cancel()
  googleYolo.show(googleYoloConfig, false).then(function(actualCredential) {
    assertNull(actualCredential)
  })
