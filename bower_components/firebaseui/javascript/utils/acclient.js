...
firebaseui.auth.acClient.tryStoreAccount = function(
  ...
  firebaseui.auth.acClient.api_.checkAccountExist(acAccount, function(
    exist,
    error
  ) {
    if (!exist && !error) {
      ...
      firebaseui.auth.acClient.api_.checkShouldUpdate(acAccount, function(
        update,
        error
      ) {
        if (update) {
          // Should update the account.
          firebaseui.auth.acClient.api_.update(account.toPlainObject(), options)
        } else {
          var isUnavailable = firebaseui.auth.acClient.isUnavailable_(error)
 ...
 */
firebaseui.auth.acClient.DummyApi.prototype.store = function(
  accounts,
  opt_config
) {
 ...
 * @param {Object=} opt_config The optional client configuration.
 */
firebaseui.auth.acClient.DummyApi.prototype.select = function(
  accounts,
  opt_config
) {
 ...
 * @param {Object=} opt_config The optional client configuration.
 */
firebaseui.auth.acClient.DummyApi.prototype.update = function(
  account,
  opt_config
) {
 ...
 * @param {function(boolean=, Object=)} callback The callback function.
 */
firebaseui.auth.acClient.DummyApi.prototype.checkAccountExist = function(
  account,
  callback
) {
  callback(undefined, firebaseui.auth.acClient.DummyApi.UNAVAILABLE_ERROR_)
 ...
 * @param {function(boolean=, Object=)} callback The callback function.
 */
firebaseui.auth.acClient.DummyApi.prototype.checkShouldUpdate = function(
  account,
  callback
) {
  callback(undefined, firebaseui.auth.acClient.DummyApi.UNAVAILABLE_ERROR_)
