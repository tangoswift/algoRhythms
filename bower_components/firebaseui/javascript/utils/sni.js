 ...
 * @private
 */
firebaseui.auth.sni.REGEX_OPERA_UA_ = /Opera[ \/]([\d.]+)(.*Version\/([\d.]+))?/
 ...
 * @private
 */
firebaseui.auth.sni.REGEX_SAFARI_UA_ = /((Windows NT ([\d.]+))|(Mac OS X ([\d_]+))).*Version\/([\d.]+).*Safari/
 ...
 * @private
 */
firebaseui.auth.sni.REGEX_MOBILE_SAFARI_UA_ = /OS ([\d_]+) like Mac OS X.*Mobile.*Safari/
 ...
 * @private
 */
firebaseui.auth.sni.REGEX_MOBILE_MSIE_UA_ = /MSIE ([\d.]+).*Windows Phone OS ([\d.]+)/
