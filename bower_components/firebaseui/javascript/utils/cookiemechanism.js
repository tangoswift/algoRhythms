 ...
 */
firebaseui.auth.CookieMechanism = function(
  opt_maxAge,
  opt_path,
  opt_domain,
  opt_secure
  ...
  this.maxAge_ =
    typeof opt_maxAge !== 'undefined' && opt_maxAge !== null ? opt_maxAge : -1
...
goog.inherits(firebaseui.auth.CookieMechanism, goog.storage.mechanism.Mechanism)
