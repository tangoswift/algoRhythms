 ...
 */
firebaseui.auth.ActionCodeUrlBuilder.prototype.setForceSameDevice = function(
  forceSameDevice
) {
 ...
 */
firebaseui.auth.ActionCodeUrlBuilder.prototype.setAnonymousUid = function(
  anonymousUid
) {
  if (anonymousUid) {
    this.uri_.setParameterValue(
 ...
 */
firebaseui.auth.ActionCodeUrlBuilder.prototype.setProviderId = function(
  providerId
) {
  if (providerId) {
    this.uri_.setParameterValue(
