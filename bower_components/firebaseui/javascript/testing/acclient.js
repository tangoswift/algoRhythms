...
FakeAcClient.prototype.install = function() {
  ...
  r.set(acClient, 'trySelectAccount', goog.bind(this.trySelectAccount_, this))
  return this
}
 ...
 */
FakeAcClient.prototype.setAvailability = function(available) {
 ...
 */
FakeAcClient.prototype.setSelectedAccount = function(account) {
 ...
 */
FakeAcClient.prototype.assertTrySelectAccount = function(
  opt_localAccounts,
  opt_callbackUrl
) {
