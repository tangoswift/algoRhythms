 ...
 */
FakeAuthClient.prototype.runAuthChangeHandler = function() {
...
FakeAuthClient.prototype.onAuthStateChanged = function(
  ...
  var observer =
    (goog.isFunction(nextOrObserver) && nextOrObserver) ||
    nextOrObserver['next']
  if (!observer) {
 ...
 */
FakeAuthClient.prototype.runIdTokenChangeHandler = function() {
