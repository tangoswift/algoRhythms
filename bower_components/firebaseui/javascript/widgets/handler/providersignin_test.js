...
function testHandleProviderSignIn_accountChooserSelect_appChange() {
  ...
  testStubs.set(firebaseui.auth.widget.dispatcher, 'getMode', function(app) {
  ...
  testAuth2.assertFetchSignInMethodsForEmail(['user@example.com'], ['password'])
