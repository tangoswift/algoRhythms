...
firebaseui.auth.widget.handler.handlePhoneSignInStart = function(
  ...
  var isPhoneProviderOnly = firebaseui.auth.widget.handler.common.isPhoneProviderOnly(
    app
  )
  ...
  app.registerPending(
    component.executePromiseRequest(
      ...
      function(widgetId) {
        ...
        firebaseui.auth.widget.handler.recaptchaWidgetId_ = /** @type {number} */ (widgetId)
      },
      function(error) {
...
firebaseui.auth.widget.handler.onPhoneSignInStartSubmit_ = function(
  ...
  app.registerPending(
    component.executePromiseRequest(
      /** @type {function (): !goog.Promise} */ (goog.bind(
        app.startSignInWithPhoneNumber,
        app
      )),
