...
/** @override */
firebaseui.auth.ui.page.EmailLinkSignInSent.prototype.enterDocument = function() {
  var self = this
 ...
 */
firebaseui.auth.ui.page.EmailLinkSignInSent.prototype.getTroubleGettingEmailLink = function() {
  return this.getElementByClass('firebaseui-id-trouble-getting-email-link')
}

/** @override */
firebaseui.auth.ui.page.EmailLinkSignInSent.prototype.disposeInternal = function() {
