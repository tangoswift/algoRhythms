...
var emailTestHelper = new firebaseui.auth.ui.element.EmailTestHelper()
  ...
  .registerTests()
var nameTestHelper = new firebaseui.auth.ui.element.NameTestHelper().registerTests()
var newPasswordTestHelper = new firebaseui.auth.ui.element.NewPasswordTestHelper().registerTests()
var formTestHelper = new firebaseui.auth.ui.element.FormTestHelper().registerTests()
...
function testInitialFocus_email() {
  ...
  component.render(root)
  assertEquals(component.getEmailElement(), goog.dom.getActiveElement(document))
}
