...
/** @override */
firebaseui.auth.ui.page.DifferentDeviceError.prototype.enterDocument = function() {
  var self = this
  ...
  firebaseui.auth.ui.page.DifferentDeviceError.base(this, 'enterDocument')
}

/** @override */
firebaseui.auth.ui.page.DifferentDeviceError.prototype.disposeInternal = function() {
  this.onDismissClick_ = null
  firebaseui.auth.ui.page.DifferentDeviceError.base(this, 'disposeInternal')
}
