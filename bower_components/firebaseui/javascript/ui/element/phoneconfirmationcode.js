...
goog.scope(function() {
  ...
  element.phoneConfirmationCode.initPhoneConfirmationCodeElement = function(
    ...
    var confirmationCodeElement = element.phoneConfirmationCode.getPhoneConfirmationCodeElement.call(
      this
    )
    var errorElement = element.phoneConfirmationCode.getPhoneConfirmationCodeErrorElement.call(
      this
    )
