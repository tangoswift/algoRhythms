...
goog.scope(function() {
  ...
  element.phoneNumber.initPhoneNumberElement = function(
    ...
    var self = this
    var phoneNumberElement = element.phoneNumber.getPhoneNumberElement.call(
      this
    )
    var countrySelectorElement = element.phoneNumber.getCountrySelectorElement.call(
      this
    )
    ...
    element.listenForInputEvent(this, phoneNumberElement, function(e) {
      ...
      var predefinedDefaultCountryAvailable = element.phoneNumber.isCountryAvailable_(
   ...
   * @private
   */
  element.phoneNumber.handleCountrySelectorButtonClick_ = function(lookupTree) {
    var self = this
  ...
  element.phoneNumber.selectCountry = function(
    ...
    var flagElement = element.phoneNumber.getCountrySelectorFlagElement_.call(
      this
    )
    if (oldCountry) {
