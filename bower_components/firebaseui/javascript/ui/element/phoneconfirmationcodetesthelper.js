...
goog.scope(function() {
  ...
  /** @private */
  element.PhoneConfirmationCodeTestHelper.prototype.testGetPhoneConfirmationCodeElement_ = function() {
    assertNotNull(this.component.getPhoneConfirmationCodeElement())
  }

  /** @private */
  element.PhoneConfirmationCodeTestHelper.prototype.testGetPhoneConfirmationCodeErrorElement_ = function() {
    assertNotNull(this.component.getPhoneConfirmationCodeErrorElement())
  }

  /** @private */
  element.PhoneConfirmationCodeTestHelper.prototype.testCheckAndGetPhoneConfirmationCode_ = function() {
  ...
  /** @private */
  element.PhoneConfirmationCodeTestHelper.prototype.testOnTextChangedClearError_ = function() {
