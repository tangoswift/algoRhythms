...
function testListBoxDialogFocus() {
  return new goog.Promise(function(resolve, reject) {
    ...
    var scrollIntoContainerViewDialog = new goog.testing.mockmatchers.SaveArgument()
    var scrollIntoContainerViewButton = new goog.testing.mockmatchers.SaveArgument()
    scrollIntoContainerView(
