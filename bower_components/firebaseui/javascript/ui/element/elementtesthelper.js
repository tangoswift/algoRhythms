 ...
 *     itself.
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.registerTests = function() {
  var self = this
 ...
 * @protected
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.fireInputEvent = function(
  input,
  keyCode
) {
 ...
 * @protected
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.fireChangeEvent = function(
  input
) {
 ...
 * @protected
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.checkInputValid = function(
  input
) {
 ...
 * @protected
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.checkInputInvalid = function(
  input
) {
 ...
 * @protected
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.checkErrorHidden = function(
  error
) {
 ...
 */
firebaseui.auth.ui.element.ElementTestHelper.prototype.checkErrorShown = function(
  error,
  errorMessage
) {
