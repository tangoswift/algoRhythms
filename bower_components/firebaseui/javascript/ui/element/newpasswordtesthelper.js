...
goog.scope(function() {
  ...
  /** @private */
  element.NewPasswordTestHelper.prototype.testGetNewPasswordElement_ = function() {
    assertNotNull(this.component.getNewPasswordElement())
  }

  /** @private */
  element.NewPasswordTestHelper.prototype.testGetNewPasswordErrorElement_ = function() {
  ...
  /** @private */
  element.NewPasswordTestHelper.prototype.testCheckAndGetNewPasswordEmpty_ = function() {
  ...
  /** @private */
  element.NewPasswordTestHelper.prototype.testCheckAndGetNewPassword_ = function() {
    var password = this.component.getNewPasswordElement()
