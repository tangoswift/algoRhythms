...
goog.scope(function() {
  ...
  /** @private */
  element.PhoneNumberTestHelper.prototype.testGetPhoneNumberElement_ = function() {
    assertNotNull(this.component.getPhoneNumberElement())
  }

  /** @private */
  element.PhoneNumberTestHelper.prototype.testGetPhoneNumberErrorElement_ = function() {
  ...
  /** @private */
  element.PhoneNumberTestHelper.prototype.testOnTextChangedClearError_ = function() {
  ...
  /** @private */
  element.PhoneNumberTestHelper.prototype.testOnCodeInputWithNationalNumber_ = function() {
    var result
    var phoneNumber = this.component.getPhoneNumberElement()
   ...
   * @private
   */
  element.PhoneNumberTestHelper.prototype.getCountrySelectorElement_ = function() {
   ...
   * @private
   */
  element.PhoneNumberTestHelper.prototype.getCountrySelectorFlagElement_ = function() {
   ...
   * @private
   */
  element.PhoneNumberTestHelper.prototype.getDialogButtonContainingText_ = function(
    text
  ) {
