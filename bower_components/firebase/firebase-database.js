!(function(t, e) {
  ...
  try {
    ...
    var p = (function() {
      ...
      v = (function() {
        return function(t, e) {
          if (((this.code = t), (this.message = e), y))
            y(this, g.prototype.create)
          else {
    ...
    var W = L.INFO,
        ...
        return (
          (t.prototype.set = function(t, e) {
            null == e
              ...
              : this.domStorage_.setItem(this.prefixedName_(t), C(e))
          }),
      ...
      G = function() {
        ...
        for (var n = '', r = 0; r < t.length; r++)
          ...
          (t[r] && 'object' == typeof t[r] && 'number' == typeof t[r].length)
            ? (n += G.apply(null, t[r]))
            : 'object' == typeof t[r] ? (n += C(t[r])) : (n += t[r]),
            (n += ' ')
        return n
      },
      X = null,
      ...
      J = function(t, e) {
        s(
          ...
          !0 === t
            ? ((K.logLevel = L.VERBOSE),
              (X = K.log.bind(K)),
              e && j.set('logging_enabled', !0))
            : 'function' == typeof t
              ? (X = t)
              : ((X = null), j.remove('logging_enabled'))
      },
      Z = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e]
        if (
          (!0 === $ &&
            (($ = !1), null === X && !0 === j.get('logging_enabled') && J(!0)),
          X)
        ) {
      ...
      wt = (function() {
        function t(t, e, n, r, i) {
          void 0 === i && (i = ''),
            ...
            (this.internalHost = B.get('host:' + t) || this.host)
        }
        return (
          ...
          (t.prototype.updateHost = function(t) {
            t !== this.internalHost &&
              ...
              this.isCacheableHost() &&
                B.set('host:' + this.host, this.internalHost))
          }),
          (t.prototype.connectionURL = function(t, e) {
            var n
            if (
              (s('string' == typeof t, 'typeof type must == string'),
              s('object' == typeof e, 'typeof params must == object'),
              'websocket' === t)
            )
              n =
    ...
    var bt,
            ...
            for (var n = 0, r = t.split('&'); n < r.length; n++) {
              ...
              if (0 !== i.length) {
                ...
                2 === o.length
                  ...
                  : rt("Invalid query segment '" + i + "' in query '" + t + "'")
              }
            }
            return e
      ...
      Ot = function(t) {
        return (
          null === t ||
          'string' == typeof t ||
          ('number' == typeof t && !it(t)) ||
          (t && 'object' == typeof t && w(t, '.sv'))
        )
      },
      ...
      xt = function(t, e, n) {
        ...
        if ('string' == typeof e && e.length > 10485760 / 3 && M(e) > 10485760)
          throw new Error(
            t +
        ...
        if (e && 'object' == typeof e) {
          ...
          if (
            (S(e, function(e, n) {
              if ('.value' === e) i = !0
              else if ('.priority' !== e && '.sv' !== e && ((o = !0), !Pt(e)))
                throw new Error(
                  t +
      ...
      Ft = function(t, e, n, r, i) {
        if (!i || void 0 !== n) {
          ...
          S(n, function(t, e) {
            var n = new mt(t)
            if ((xt(o, e, r.child(n)), '.priority' === n.getBack() && !Ot(e)))
              throw new Error(
                o +
        ...
        return (
          ...
          (t.prototype.remove = function(t) {
            k('OnDisconnect.remove', 0, 1, arguments.length),
              qt('OnDisconnect.remove', this.path_),
          ...
          (t.prototype.set = function(t, e) {
            k('OnDisconnect.set', 1, 2, arguments.length),
              qt('OnDisconnect.set', this.path_),
              kt('OnDisconnect.set', 1, t, this.path_, !1),
          ...
          (t.prototype.setWithPriority = function(t, e, n) {
            k('OnDisconnect.setWithPriority', 2, 3, arguments.length),
              qt('OnDisconnect.setWithPriority', this.path_),
              kt('OnDisconnect.setWithPriority', 1, t, this.path_, !1),
          ...
          (t.prototype.update = function(t, e) {
            if (
              ...
              qt('OnDisconnect.update', this.path_),
              Array.isArray(t))
            ) {
            ...
            Ft('OnDisconnect.update', 1, t, this.path_, !1),
      ...
      function(t) {
        ...
        var r = new Array(8)
        for (e = 7; e >= 0; e--)
          (r[e] = Xn.charAt(t % 64)), (t = Math.floor(t / 64))
          ...
          (t.prototype.hash = function() {
            if (null === this.lazyHash_) {
              ...
              this.priorityNode_.isEmpty() ||
                (t += 'priority:' + $t(this.priorityNode_.val()) + ':')
              var e = typeof this.value_
              ;(t += e + ':'),
                (t += 'number' === e ? dt(this.value_) : this.value_),
                (this.lazyHash_ = z(t))
            }
          ...
          (t.prototype.compareTo = function(e) {
            return e === t.__childrenNodeConstructor.EMPTY_NODE
              ...
              : e instanceof t.__childrenNodeConstructor
                ? -1
                : (s(e.isLeafNode(), 'Unknown node type'),
      ...
      ie = (function() {
        function t(e, n, r, i, o) {
          ;(this.key = e),
            ...
            (this.left = null != i ? i : se.EMPTY_NODE),
            (this.right = null != o ? o : se.EMPTY_NODE)
        }
        return (
          ...
          (t.prototype.insert = function(e, n) {
            return new t(
              ...
              this.root_
                ...
                .copy(null, null, ie.BLACK, null, null)
            )
          }),
        ...
        var i = function(e, r) {
            ...
            if (1 == a)
              return (
                (o = t[e]),
                (s = n ? n(o) : o),
                new ie(s, o.node, ie.BLACK, null, null)
              )
            var h = parseInt(a / 2, 10) + e,
              u = i(e, h),
              l = i(h + 1, r)
            return (
              (o = t[h]), (s = n ? n(o) : o), new ie(s, o.node, ie.BLACK, u, l)
            )
          },
          o = (function(e) {
            for (
      ...
      ce = (function() {
        ...
        return (
          Object.defineProperty(t, 'Default', {
            get: function() {
              return (
                s(le && ne, 'ChildrenNode.ts has not been loaded'),
                (te = te || new t({'.priority': le}, {'.priority': ne}))
              )
            },
            enumerable: !0,
            configurable: !0
          ...
          (t.prototype.addIndex = function(e, n) {
            ...
            for (
              var r,
                i = [],
                o = !1,
                a = n.getIterator(Bt.Wrap),
                h = a.getNext();
              h;

            )
              (o = o || e.isDefinedOn(h.node)), i.push(h), (h = a.getNext())
          ...
          (t.prototype.addToIndexes = function(e, n) {
            var r = this
            return new t(
              R(this.indexes_, function(t, i) {
                var o = b(r.indexSet_, i)
                if ((s(o, 'Missing index implementation for ' + i), t === le)) {
                  if (o.isDefinedOn(e.node)) {
                    for (
                      var a = [], h = n.getIterator(Bt.Wrap), u = h.getNext();
                      u;

                    )
                      u.name != e.name && a.push(u), (u = h.getNext())
                ...
                var l = n.get(e.name),
                  c = t
                return (
                  l && (c = c.remove(new Bt(e.name, l))), c.insert(e, e.node)
                )
              }),
              this.indexSet_
            )
    ...
    var fe = (function() {
        function t(t, e, n) {
          ;(this.children_ = t),
            ...
            (this.indexMap_ = n),
            (this.lazyHash_ = null),
            this.priorityNode_ && Jt(this.priorityNode_),
        ...
        return (
          ...
          (t.prototype.updateImmediateChild = function(e, n) {
            if (
              (s(n, 'We should always be passing snapshot nodes'),
              '.priority' === e)
            )
            ...
            return (
              ...
              new t(i, i.isEmpty() ? ee : this.priorityNode_, o)
            )
          }),
          ...
          (t.prototype.val = function(e) {
            ...
            var n = {},
              ...
              o = !0
            if (
              (this.forEachChild(ne, function(s, a) {
                ;(n[s] = a.val(e)),
                  r++,
          ...
          (t.prototype.hash = function() {
            if (null === this.lazyHash_) {
              var t = ''
              this.getPriority().isEmpty() ||
                (t += 'priority:' + $t(this.getPriority().val()) + ':'),
                this.forEachChild(ne, function(e, n) {
                  var r = n.hash()
                  '' !== r && (t += ':' + e + ':' + r)
                }),
          ...
          (t.prototype.getReverseIteratorFrom = function(t, e) {
            ...
            for (
              var r = this.children_.getReverseIteratorFrom(t.name, Bt.Wrap),
                i = r.peek();
              null != i && e.compare(i, t) > 0;
          ...
          (t.prototype.compareTo = function(t) {
            return this.isEmpty()
              ? t.isEmpty() ? 0 : -1
              : t.isLeafNode() || t.isEmpty() ? 1 : t === _e ? -1 : 0
          }),
    ...
    Object.defineProperties(Bt, {
      MIN: {value: new Bt(ot, fe.EMPTY_NODE)},
      MAX: {value: new Bt(st, _e)}
    }),
      (Kt.__EMPTY_NODE = fe.EMPTY_NODE),
      (Zt.__childrenNodeConstructor = fe),
      (St = _e),
      (function(t) {
        Xt = t
      })(_e)
    ...
    function ve(t, e) {
      ...
      if (
        (S(a, function(t, e) {
          if ('string' != typeof t || '.' !== t.substring(0, 1)) {
            var n = ve(a[t])
            n.isEmpty() ||
              ((o = o || !n.getPriority().isEmpty()), i.push(new Bt(t, n)))
          }
        }),
        0 == i.length)
      )
      ...
      if (o) {
        ...
        return new fe(h, ve(e), new ce({'.priority': u}, {'.priority': ne}))
      }
    ...
    var ge,
        ...
        return (
          ...
          (t.prototype.hasChild = function(t) {
            k('DataSnapshot.hasChild', 1, 1, arguments.length),
              Wt('DataSnapshot.hasChild', 1, t, !1)
            var e = new mt(t)
        ...
        return (
          ...
          (t.validateQueryEndpoints_ = function(t) {
            ...
            if (
              ...
              (s(
                t.getIndex() instanceof Ee || t.getIndex() === Ce,
                'unknown index type.'
              ),
          ...
          (t.prototype.off = function(t, e, n) {
            ...
            var r = null,
              i = null
            'value' === t
              ? (r = new Te(e || null, null, n || null))
              : t && (e && ((i = {})[t] = e), (r = new Ne(i, null, n || null)))
          ...
          (t.prototype.orderByChild = function(e) {
            if ((k('Query.orderByChild', 1, 1, arguments.length), '$key' === e))
              throw new Error(
          ...
          (t.prototype.startAt = function(e, n) {
            void 0 === e && (e = null),
              ...
              kt('Query.startAt', 1, e, this.path, !0),
              Mt('Query.startAt', 2, n, !0)
          ...
          (t.prototype.endAt = function(e, n) {
            void 0 === e && (e = null),
              ...
              kt('Query.endAt', 1, e, this.path, !0),
              Mt('Query.endAt', 2, n, !0)
          ...
          (t.prototype.equalTo = function(t, e) {
            if (
              ...
              kt('Query.equalTo', 1, t, this.path, !1),
              Mt('Query.equalTo', 2, e, !0),
              this.queryParams_.hasStart())
            )
              throw new Error(
          ...
          (t.prototype.isEqual = function(e) {
            if (
              (k('Query.isEqual', 1, 1, arguments.length), !(e instanceof t))
            ) {
              throw new Error(
        ...
        return (
          ...
          (t.prototype.forget = function(t) {
            ...
            if (null !== this.value_) {
              ...
              var n = this
              return (
                e.forEachChild(ne, function(t, e) {
      ...
      Oe = function(t, e) {
        ...
        return (
          (n = a),
          i !== a.getPriority().val() && (n = n.updatePriority(new Zt(i))),
          a.forEachChild(ne, function(t, r) {
            var i = Oe(r, e)
    ...
    var ke,
      ...
      Fe = (function() {
        function t(t, e, n, r) {
          ;(this.fromUser = t),
            ...
            (this.queryId = n),
            (this.tagged = r),
            s(!r || e, 'Tagged queries must be from server.')
        }
        return (
        ...
        return (
          ...
          (t.prototype.findRootMostMatchingPathAndValue = function(t, e) {
            ...
            if (null !== r) {
              ...
              return null != i
                ? {path: new mt(n).child(i.path), value: i.value}
                : null
            }
            return null
          }),
      ...
      qe = (function() {
        function t(t, e, n) {
          ;(this.source = t),
            (this.path = e),
            (this.snap = n),
            (this.type = me.OVERWRITE)
        }
        return (
          (t.prototype.operationForChild = function(e) {
            return this.path.isEmpty()
              ? new t(this.source, mt.Empty, this.snap.getImmediateChild(e))
          ...
          (t.prototype.operationForChild = function(e) {
            if (this.path.isEmpty()) {
              ...
              return n.isEmpty()
                ? null
                : n.value
                  ? new qe(this.source, mt.Empty, n.value)
                  : new t(this.source, mt.Empty, n)
            }
            return (
              s(
                this.path.getFront() === e,
        ...
        return (
          (t.prototype.updateChild = function(t, e, n, r, i, o) {
            ...
            return a.getChild(r).equals(n.getChild(r)) &&
              ...
              : (null != o &&
                  (n.isEmpty()
                    ? t.hasChild(e)
                      ? o.trackChildChange(He.childRemovedChange(e, a))
                      : s(
                          t.isLeafNode(),
                          'A child remove without an old child only makes sense on a leaf node'
                        )
                    : a.isEmpty()
                      ? o.trackChildChange(He.childAddedChange(e, n))
                      : o.trackChildChange(He.childChangedChange(e, n, a))),
          ...
          (t.prototype.updateFullNode = function(t, e, n) {
            return (
              null != n &&
                (t.isLeafNode() ||
                  t.forEachChild(ne, function(t, r) {
                    e.hasChild(t) ||
                      n.trackChildChange(He.childRemovedChange(t, r))
                  }),
                e.isLeafNode() ||
                  e.forEachChild(ne, function(e, r) {
                    if (t.hasChild(e)) {
                      var i = t.getImmediateChild(e)
                      i.equals(r) ||
                        n.trackChildChange(He.childChangedChange(e, r, i))
      ...
      je = (function() {
        ...
        return (
          (t.prototype.trackChildChange = function(t) {
            ...
            if (r) {
              var i = r.type
              if (e == He.CHILD_ADDED && i == He.CHILD_REMOVED)
                this.changeMap_[n] = He.childChangedChange(
                  n,
                  t.snapshotNode,
                  r.snapshotNode
                )
              else if (e == He.CHILD_REMOVED && i == He.CHILD_ADDED)
                delete this.changeMap_[n]
              else if (e == He.CHILD_REMOVED && i == He.CHILD_CHANGED)
                this.changeMap_[n] = He.childRemovedChange(n, r.oldSnap)
              else if (e == He.CHILD_CHANGED && i == He.CHILD_ADDED)
                this.changeMap_[n] = He.childAddedChange(n, t.snapshotNode)
              else {
                if (e != He.CHILD_CHANGED || i != He.CHILD_CHANGED)
                  throw a(
          ...
          (t.prototype.getCompleteChild = function(t) {
            ...
            var n =
              null != this.optCompleteServerCache_
                ? new Ue(this.optCompleteServerCache_, !0, !1)
        ...
        return (
          ...
          (t.prototype.applyOperation = function(e, n, r, i) {
            ...
            if (n.type === me.OVERWRITE) {
              var l = n
              l.source.fromUser
                ? (o = this.applyUserOverwrite_(e, l.path, l.snap, r, i, u))
                : (s(l.source.fromServer, 'Unknown source.'),
                  (h =
                    l.source.tagged ||
              ...
              c.source.fromUser
                ...
                : (s(c.source.fromServer, 'Unknown source.'),
                  (h = c.source.tagged || e.getServerCache().isFiltered()),
              ...
              var p = n
              o = p.revert
                ? this.revertUserWrite_(e, p.path, r, i, u)
                : this.ackUserWrite_(e, p.path, p.affectedTree, r, i, u)
            } else {
              if (n.type !== me.LISTEN_COMPLETE)
                throw a('Unknown operation type: ' + n.type)
          ...
          (t.maybeAddValueEvent_ = function(t, e, n) {
            ...
            if (r.isFullyInitialized()) {
              ...
              ;(n.length > 0 ||
                ...
                n.push(He.valueChange(e.getCompleteEventSnap()))
            }
          }),
            ...
            if (e.isEmpty()) a = u.updateFullNode(h.getNode(), n, null)
              ...
              a =
                '.priority' == c
                  ...
                  : u.updateChild(h.getNode(), c, d, p, Ke, null)
            }
          ...
          (t.prototype.revertUserWrite_ = function(t, e, n, r, i) {
            ...
            if (e.isEmpty() || '.priority' === e.getFront()) {
              ...
              null == d &&
                ...
                (u =
                  null != d
                    ? this.filter_.updateChild(h, p, d, e.popFront(), a, i)
                    : t
                        .getEventCache()
                        .getNode()
                        .hasChild(p)
        ...
        return (
          (t.prototype.generateEventsForChanges = function(t, e, n) {
            ...
            return (
              t.forEach(function(t) {
                t.type === He.CHILD_CHANGED &&
                  r.index_.indexedValueChanged(t.oldSnap, t.snapshotNode) &&
                  o.push(He.childMovedChange(t.childName, t.snapshotNode))
              }),
              this.generateEventsForType_(i, He.CHILD_REMOVED, t, n, e),
              this.generateEventsForType_(i, He.CHILD_ADDED, t, n, e),
              this.generateEventsForType_(i, He.CHILD_MOVED, o, n, e),
              this.generateEventsForType_(i, He.CHILD_CHANGED, t, n, e),
              this.generateEventsForType_(i, He.VALUE, t, n, e),
              i
            )
          }),
          ...
          (t.prototype.compareChanges_ = function(t, e) {
            if (null == t.childName || null == e.childName)
              throw a('Should only compare child_ events.')
      ...
      $e = (function() {
        function t(t, e) {
          ...
          ;(this.viewCache_ = new Ve(l, u)),
            (this.eventGenerator_ = new Xe(this.query_))
        }
        return (
          ...
          (t.prototype.getInitialEvents = function(t) {
            ...
            e.getNode().isLeafNode() ||
              e.getNode().forEachChild(ne, function(t, e) {
                n.push(He.childAddedChange(t, e))
              })
            return (
              e.isFullyInitialized() && n.push(He.valueChange(e.getNode())),
      ...
      Je = (function() {
        ...
        return (
          Object.defineProperty(t, '__referenceConstructor', {
            ...
            set: function(t) {
              s(!xe, '__referenceConstructor has already been defined'),
                (xe = t)
            },
            enumerable: !0,
            configurable: !0
          ...
          (t.prototype.applyOperation = function(t, e, n) {
            ...
            if (null !== r) {
              ...
              return (
                s(null != i, 'SyncTree gave us an op for an invalid query.'),
                i.applyOperation(t, e, n)
              )
            }
            var o = []
            return (
              S(this.views_, function(r, i) {
      ...
      Ze = (function() {
        ...
        return (
          ...
          (t.prototype.removeWrite = function(e) {
            return e.isEmpty()
              ? t.Empty
              : new t(this.writeTree_.setTree(e, Me.Empty))
          }),
          ...
          (t.prototype.getCompleteChildren = function() {
            ...
            return (
              null != e
                ? e.isLeafNode() ||
                  e.forEachChild(ne, function(e, n) {
                    t.push(new Bt(e, n))
                  })
        ...
        return (
          ...
          (t.prototype.removeWrite = function(t) {
            ...
            for (
              ...
              h.visible &&
                (a >= n && this.recordContainsPath_(h, r.path)
                  ? (i = !1)
          ...
          (t.prototype.calcCompleteEventChildren = function(t, e) {
            ...
            if (r)
              return (
                r.isLeafNode() ||
                  r.forEachChild(ne, function(t, e) {
          ...
          (t.layerTree_ = function(t, e, n) {
            for (var r = Ze.Empty, i = 0; i < t.length; ++i) {
              ...
              if (e(o)) {
                ...
                if (o.snap)
                  n.contains(s)
                    ? ((h = mt.relativePath(n, s)), (r = r.addWrite(h, o.snap)))
                    : s.contains(n) &&
                      ((h = mt.relativePath(s, n)),
                      (r = r.addWrite(mt.Empty, o.snap.getChild(h))))
                else {
                  if (!o.children)
                    throw a('WriteRecord should have .snap or .children')
                  if (n.contains(s))
                    (h = mt.relativePath(n, s)),
                      (r = r.addWrites(h, o.children))
                  else if (s.contains(n))
                    if ((h = mt.relativePath(s, n)).isEmpty())
      ...
      nn = (function() {
        function t(t) {
          ;(this.listenProvider_ = t),
            (this.syncPointTree_ = Me.Empty),
            (this.pendingWriteTree_ = new tn()),
            (this.tagToQueryMap_ = {}),
            (this.queryToTagMap_ = {})
        }
        return (
          (t.prototype.applyUserOverwrite = function(t, e, n, r) {
            return (
              ...
              r ? this.applyOperationToSyncPoints_(new qe(Fe.User, t, e)) : []
            )
          }),
          ...
          (t.prototype.addEventRegistration = function(e, n) {
            ...
            ;(h
              ? ((o = o || h.hasCompleteView()),
                (i = i || h.getCompleteServerCache(mt.Empty)))
              : ((h = new Je()),
          ...
          (t.parseQueryKey_ = function(t) {
            var e = t.indexOf('$')
            return (
              s(-1 !== e && e < t.length - 1, 'Bad queryKey.'),
      ...
      an = (function() {
        ...
        return (
          (t.getCollection = function(t) {
            var e = t.toString()
            return (
              this.collections_[e] || (this.collections_[e] = new sn()),
              this.collections_[e]
            )
          }),
      ...
      fn = (function() {
        function t(t) {
          ;(this.allowedEvents_ = t),
            (this.listeners_ = {}),
            s(Array.isArray(t) && t.length > 0, 'Requires a non-empty array')
        }
        return (
      ...
      _n = (function(t) {
        ...
        return (
          ...
          (e.prototype.getInitialEvent = function(t) {
            return (
              s('visible' === t, 'Unknown event type: ' + t), [this.visible_]
            )
          }),
          e
        )
      ...
      En = (function() {
        function t(e, n, r, i) {
          if (
            ((this.onDisconnect = r),
            (this.urlFn = i),
            (this.outstandingRequests = new Re()),
            (this.pendingSegs = []),
            ...
            ;(this.uniqueCallbackIdentifier = Y()),
              (window[gn + this.uniqueCallbackIdentifier] = e),
              (window[mn + this.uniqueCallbackIdentifier] = n),
              ...
              : setTimeout(function() {
                  try {
                    ...
                    ;(r.type = 'text/javascript'),
                      ...
                      (r.onerror = function() {
                        Z('Long-poll script failed to load: ' + t),
                          (n.sendNewPolls = !1),
                          n.close()
                      }),
    ...
    'undefined' != typeof MozWebSocket
      ? (wn = MozWebSocket)
      : 'undefined' != typeof WebSocket && (wn = WebSocket)
    var bn = (function() {
        function t(e, n, r, i) {
          ;(this.connId = e),
        ...
        return (
          ...
          (t.prototype.open = function(t, n) {
            ...
            ;(this.onDisconnect = n),
              ...
              (this.everConnected_ = !1),
              B.set('previous_websocket_failure', !0)
            try {
              if (f()) {
          ...
          (t.previouslyFailed = function() {
            return (
              B.isInMemoryStorage || !0 === B.get('previous_websocket_failure')
            )
          }),
          (t.prototype.markConnectionHealthy = function() {
          ...
          (t.prototype.extractFrameCount_ = function(t) {
            if (
              (s(null === this.frames, 'We already have a frame buffer'),
              t.length <= 6)
            ) {
              var e = Number(t)
      ...
      Tn = (function() {
        function t(t, e, n, r, i, o, s) {
          ;(this.id = t),
            ...
            (this.state_ = 0),
            (this.log_ = tt('c:' + this.id + ':')),
            (this.transportManager_ = new Sn(e)),
        ...
        return (
          (t.prototype.start_ = function() {
            ...
            i > 0 &&
              (this.healthyTimeout_ = gt(function() {
                  ...
                  : 'r' === e
                    ...
                    : 'e' === e
                      ...
                      : 'o' === e
                        ...
                        : et('Unknown control packet command: ' + e)
            }
          }),
          (t.prototype.onHandshake_ = function(t) {
            ...
            ;(this.sessionId = t.s),
              ...
              0 == this.state_ &&
                ...
                '5' !== n && rt('Protocol version mismatch detected'),
              ...
              t || 0 !== this.state_
                ...
                : (this.log_('Realtime connection failed.'),
                  this.repoInfo_.isCacheableHost() &&
                    (B.remove('host:' + this.repoInfo_.host),
      ...
      Pn = (function(t) {
        function n(e, r, i, o, s, a) {
          ...
          if (
            ...
            (h.connected_ = !1),
            (h.reconnectDelay_ = In),
            (h.maxReconnectDelay_ = Rn),
          ...
          return (
            ...
            _n.getInstance().on('visible', h.onVisible_, h),
            -1 === e.host.indexOf('fblocal') &&
              yn.getInstance().on('online', h.onOnline_, h),
            h
          )
        }
        return (
          ...
          (n.prototype.reduceReconnectDelayIfAdminCredential_ = function(t) {
            var e
            ;((t && 40 === t.length) ||
              ('object' == typeof (e = E(t).claims) && !0 === e.admin)) &&
              (this.log_(
            ...
            if (this.shouldReconnect_()) {
              ...
              ;(this.forceTokenRefresh_ = !1),
                this.authTokenProvider_
                  ...
                  .then(function(n) {
                    u
                      ? Z('getToken() completed but was canceled')
                      : (Z('getToken() completed. Creating connection.'),
                        (a.authToken_ = n && n.accessToken),
                        (l = new Tn(
                          i,
                          a.repoInfo_,
                          t,
                  ...
                  .then(null, function(t) {
                    a.log_('Failed to get token: ' + t),
                      u || (o.NODE_ADMIN && rt(t), c())
                  })
            }
          }),
          (n.prototype.interrupt = function(t) {
            Z('Interrupting connection for reason: ' + t),
          ...
          (n.prototype.resume = function(t) {
            Z('Resuming connection for reason: ' + t),
            ...
            return (
              void 0 !== this.listens_[r]
                ? ((n = this.listens_[r][e]),
                  ...
                  0 === I(this.listens_[r]) && delete this.listens_[r])
                : (n = void 0),
              n
            )
          }),
          (n.prototype.onAuthRevoked_ = function(t, e) {
            Z('Auth token revoked: ' + t + '/' + e),
          ...
          (n.prototype.sendConnectStats_ = function() {
            var t = {},
              n = 'js'
            o.NODE_ADMIN ? (n = 'admin_node') : o.NODE_CLIENT && (n = 'node'),
      ...
      On = (function() {
        function t(t, e, n) {
          ...
          ;(this.repoInfo_ = t),
            ...
            (this.eventQueue_ = new pn()),
            (this.nextWriteId_ = 1),
            (this.interceptServerDataCallback_ = null),
            (this.onDisconnect_ = new Pe()),
            (this.persistentConnection_ = null)
          var i = new on(n)
          if (((this.stats_ = an.getCollection(t)), e || vt()))
            (this.server_ = new Dn(
              this.repoInfo_,
            ...
            ;(this.persistentConnection_ = new Pn(
              this.repoInfo_,
              this.onDataUpdate_.bind(this),
          ...
          i.addTokenChangeListener(function(t) {
            ...
            (this.infoData_ = new rn()),
            (this.infoSyncTree_ = new nn({
        ...
        return (
          ...
          (t.prototype.update = function(t, e, n) {
            ...
            if (
              ...
              Z("update() called with empty data.  Don't do anything."),
          ...
          (t.prototype.runOnDisconnectEvents_ = function() {
            ...
            ;(function(t, e) {
              var n = new Pe()
              return (
                t.forEachTree(new mt(''), function(t, r) {
                  n.remember(t, Oe(r, e))
                }),
                n
              )
              ...
              (this.onDisconnect_ = new Pe()),
              this.eventQueue_.raiseEventsForChangedPath(mt.Empty, n)
          }),
          (t.prototype.onDisconnectCancel = function(t, e) {
            var n = this
          ...
          (t.prototype.stats = function(t) {
            if ((void 0 === t && (t = !1), 'undefined' != typeof console)) {
              ...
              t
                ? (this.statsListener_ ||
                    (this.statsListener_ = new hn(this.stats_)),
                  (e = this.statsListener_.get()))
                : (e = this.stats_.get())
      ...
      kn = (function() {
        ...
        return (
          ...
          (t.prototype.updateChild = function(t, e, n, r, i, o) {
            return (
              this.matches(new Bt(e, n)) || (n = fe.EMPTY_NODE),
            ...
            return (
              e.forEachChild(ne, function(t, e) {
                i.matches(new Bt(t, e)) ||
                  (r = r.updateImmediateChild(t, fe.EMPTY_NODE))
              }),
      ...
      xn = (function() {
        ...
        return (
          (t.prototype.updateChild = function(t, e, n, r, i, o) {
            return (
              this.rangedFilter_.matches(new Bt(e, n)) || (n = fe.EMPTY_NODE),
              ...
              for (var c = !1; i.hasNext(); ) {
                ...
                !c && u(a, s) <= 0 && (c = !0),
                  c && o < this.limit_ && u(s, h) <= 0
                    ? o++
                    : (r = r.updateImmediateChild(s.name, fe.EMPTY_NODE))
              }
            }
          ...
          (t.prototype.fullLimitUpdateChild_ = function(t, e, n, r, i) {
            ...
            if (h.hasChild(e)) {
              ...
              if (c && !n.isEmpty() && f >= 0)
                return (
                  null != i &&
                    i.trackChildChange(He.childChangedChange(e, n, p)),
              ...
              return null != d && this.rangedFilter_.matches(d)
                ? (null != i &&
                    i.trackChildChange(He.childAddedChange(d.name, d.node)),
            ...
            return n.isEmpty()
              ...
              : c && o(l, u) >= 0
                ? (null != i &&
                    (i.trackChildChange(He.childRemovedChange(l.name, l.node)),
                    i.trackChildChange(He.childAddedChange(e, n))),
                  h
                    .updateImmediateChild(e, n)
                    .updateImmediateChild(l.name, fe.EMPTY_NODE))
                : t
          }),
          t
        )
      ...
      Fn = (function() {
        ...
        return (
          ...
          (t.prototype.getIndexStartName = function() {
            return (
              s(this.startSet_, 'Only valid if start has been set'),
              this.startNameSet_ ? this.indexStartName_ : ot
            )
          }),
          ...
          (t.prototype.getIndexEndName = function() {
            return (
              s(this.endSet_, 'Only valid if end has been set'),
              this.endNameSet_ ? this.indexEndName_ : st
            )
          }),
          ...
          (t.prototype.getLimit = function() {
            return (
              s(this.limitSet_, 'Only valid if limit has been set'), this.limit_
            )
          }),
          (t.prototype.getIndex = function() {
            return this.index_
          ...
          (t.prototype.getQueryObject = function() {
            ...
            return (
              this.index_ !== ne && (n[e.INDEX] = this.index_.toString()), n
            )
          }),
          ...
          (t.prototype.getNodeFilter = function() {
            return this.loadsAllData()
              ...
              : this.hasLimit() ? new xn(this) : new kn(this)
          }),
              ...
              : (this.index_ === ne
                  ...
                  : this.index_ === Ce
                    ...
                    : this.index_ === Yt
                      ? (e = n.KEY_INDEX)
                      : (s(
                          this.index_ instanceof Ee,
                          'Unrecognized index type!'
                        ),
                        (e = this.index_.toString())),
                (r[n.ORDER_BY] = C(e)),
                this.startSet_ &&
                  ((r[n.START_AT] = C(this.indexStartValue_)),
                  this.startNameSet_ &&
                    (r[n.START_AT] += ',' + C(this.indexStartName_))),
                this.endSet_ &&
                  ((r[n.END_AT] = C(this.indexEndValue_)),
                  this.endNameSet_ &&
                    (r[n.END_AT] += ',' + C(this.indexEndName_))),
                this.limitSet_ &&
                  (this.isViewFromLeft()
        ...
        return (
          ...
          (e.prototype.set = function(t, e) {
            k('Reference.set', 1, 2, arguments.length),
              qt('Reference.set', this.path),
              kt('Reference.set', 1, t, this.path, !1),
          ...
          (e.prototype.update = function(t, e) {
            ...
            Ft('Reference.update', 1, t, this.path, !1),
          ...
          (e.prototype.setWithPriority = function(t, e, n) {
            if (
              ...
              qt('Reference.setWithPriority', this.path),
              kt('Reference.setWithPriority', 1, t, this.path, !1),
          ...
          (e.prototype.transaction = function(t, e, n) {
            if (
              ...
              qt('Reference.transaction', this.path),
              F('Reference.transaction', 1, t, !1),
              F('Reference.transaction', 2, e, !0),
              (function(t, e, n, r) {
            ...
            return (
              this.repo.startTransaction(
                ...
                t,
                function(t, n, i) {
                  t ? r.reject(t) : r.resolve(new Vt(n, i)),
          ...
          (e.prototype.setPriority = function(t, e) {
            k('Reference.setPriority', 1, 2, arguments.length),
              qt('Reference.setPriority', this.path),
          ...
          (e.prototype.push = function(t, e) {
            k('Reference.push', 0, 2, arguments.length),
              qt('Reference.push', this.path),
              kt('Reference.push', 1, t, this.path, !0),
          ...
          (e.prototype.onDisconnect = function() {
            return (
              qt('Reference.onDisconnect', this.path),
              new Ut(this.repo, this.path)
            )
          }),
    ...
    var Ln,
      ...
      Wn = (function() {
        ...
        return (
          (t.prototype.subTree = function(e) {
            for (
              var n, r = e instanceof mt ? e : new mt(e), i = this;
              null !== (n = r.getFront());

            ) {
              ;(i = new t(n, i, b(i.node_.children, n) || new Mn())),
                (r = r.popFront())
            }
            return i
          }),
          ...
          (t.prototype.setValue = function(t) {
            s(void 0 !== t, 'Cannot set value to undefined'),
              (this.node_.value = t),
              this.updateParents_()
          }),
          (t.prototype.clear = function() {
    ...
    !(function(t) {
      ...
      (On.MAX_TRANSACTION_RETRIES_ = 25),
      (On.prototype.transactions_init_ = function() {
      ...
      (On.prototype.startTransaction = function(t, e, n, r) {
        ...
        if (void 0 === u) {
          ...
          xt('transaction failed: Data returned ', u, a.path),
            (a.status = Ln.RUN)
          var c = this.transactionQueueTree_.subTree(t),
            p = c.getValue() || []
          p.push(a), c.setValue(p)
          var d = void 0
          if ('object' == typeof u && null !== u && w(u, '.priority'))
            (d = b(u, '.priority')),
              s(
                Ot(d),
            ...
            d = (
              this.serverSyncTree_.calcCompleteEventCache(t) || fe.EMPTY_NODE
            )
              .getPriority()
              .val()
          d = d
      ...
      (On.prototype.getLatestState_ = function(t, e) {
        return (
          this.serverSyncTree_.calcCompleteEventCache(t, e) || fe.EMPTY_NODE
        )
      }),
            ...
            if ('ok' === r) {
              ...
              if ('datastale' === r)
                for (s = 0; s < e.length; s++)
                  e[s].status === Ln.SENT_NEEDS_ABORT
                    ? (e[s].status = Ln.NEEDS_ABORT)
                    : (e[s].status = Ln.RUN)
              else {
                rt('transaction at ' + p.toString() + ' failed: ' + r)
                for (s = 0; s < e.length; s++)
                  (e[s].status = Ln.NEEDS_ABORT), (e[s].abortReason = r)
              }
        ...
        if (0 !== t.length) {
          for (
            ...
            if (
              ...
              h.status === Ln.NEEDS_ABORT)
            )
              (l = !0),
                (c = h.abortReason),
                (i = i.concat(
                  this.serverSyncTree_.ackUserWrite(h.currentWriteId, !0)
                ))
            else if (h.status === Ln.RUN)
              if (h.retryCount >= On.MAX_TRANSACTION_RETRIES_)
                (l = !0),
                  (c = 'maxretry'),
                  (i = i.concat(
                    this.serverSyncTree_.ackUserWrite(h.currentWriteId, !0)
                ...
                if (void 0 !== d) {
                  ...
                  var f = ve(d)
                  ;('object' == typeof d && null != d && w(d, '.priority')) ||
      ...
      (On.prototype.pruneCompletedTransactionsBelowNode_ = function(t) {
        ...
        if (n) {
          for (var r = 0, i = 0; i < n.length; i++)
            n[i].status !== Ln.COMPLETED && ((n[r] = n[i]), r++)
      ...
      (On.prototype.abortTransactionsOnNode_ = function(t) {
        ...
        if (null !== e) {
          for (var n = [], r = [], i = -1, o = 0; o < e.length; o++)
            ...
            else if (e[o].status === Ln.SENT)
              s(i === o - 1, 'All SENT items should be at beginning of queue.'),
                (i = o),
                (e[o].status = Ln.SENT_NEEDS_ABORT),
                (e[o].abortReason = 'set')
            else if (
              (s(
                e[o].status === Ln.RUN,
        ...
        return (
          ...
          (t.prototype.databaseFromApp = function(t, e) {
            ...
            var r = Tt(n),
              i = r.repoInfo
            return (
              Qt('Invalid Firebase Database URL', 1, r),
              r.path.isEmpty() ||
                nt(
          ...
          (t.prototype.deleteRepo = function(t) {
            ...
            ;(e && b(e, t.repoInfo_.toURLString()) === t) ||
              nt(
                'Database ' +
                  t.app.name +
                  '(' +
          ...
          (t.prototype.createRepo = function(t, e) {
            ...
            return (
              ...
              (r = new On(t, this.useRestClient_, e)),
              (n[t.toURLString()] = r),
              r
            )
          }),
      ...
      Un = (function() {
        ...
        return (
          ...
          (t.prototype.checkDeleted_ = function(t) {
            null === this.repo_ &&
              nt('Cannot call ' + t + ' on a deleted database.')
          }),
              ...
              (r = function() {
                return i(this, function(t) {
                  return (
                    ...
                    Qn.getInstance().deleteRepo(this.database.repo_),
    ...
    var jn = Tn,
      ...
      Yn = Object.freeze({
        ...
        hijackHash: function(t) {
          ...
          return (
            (Pn.prototype.put = function(n, r, i, o) {
      ...
      zn = Un.ServerValue
    function Gn(t) {
      var e = t.INTERNAL.registerService(
        'database',
        function(t, e, n) {
